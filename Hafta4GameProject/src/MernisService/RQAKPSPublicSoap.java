...
public class RQAKPSPublicSoap
{
    ...
    public RQAKPSPublicSoap(){}

    public RQAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RQAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RQAExtendedSoapSerializationEnvelope envelope= new RQAExtendedSoapSerializationEnvelope(RQAExtendedSoapSerializationEnvelope.VER11);
