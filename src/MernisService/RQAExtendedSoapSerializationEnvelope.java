...
public class RQAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RQADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RQAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RQADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RQADateTimeConverter dateTimeConverter = new RQAStandardDateTimeConverter();

    public RQAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RQAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RQAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RQAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RQAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RQAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
