...
public class MUAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MUADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MUAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MUADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MUADateTimeConverter dateTimeConverter = new MUAStandardDateTimeConverter();

    public MUAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MUAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MUAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MUAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MUAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MUAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
