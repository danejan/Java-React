...
public class MUAKPSPublicSoap
{
    ...
    public MUAKPSPublicSoap(){}

    public MUAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MUAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MUAExtendedSoapSerializationEnvelope envelope= new MUAExtendedSoapSerializationEnvelope(MUAExtendedSoapSerializationEnvelope.VER11);
